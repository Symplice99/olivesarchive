              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Entrer votre identifiant & mot de passe de connexion</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-12">
                        @if (Route::has('password.request'))
                                ...
                                @endif
                      <p class="small mb-0">Vous n'avez pas de compte ? <a href="{{ route('register') }}">{{ __('Register') }}</a></p>
                    </div>
                  </form>
