...
<main>
    <div class="container">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Entrer vos données personelles pour créer un compte</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{ route('register') }}">
                    ...
                    {{-- nom --}}
                    <div class="col-12">
                      <label for="yourName" class="form-label">{{ __('Pseudo') }}</label>
                      <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
     ...
     {{-- email --}}
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Vous avez déjà un compte? <a href="{{ route('login') }}">{{ __('Connexion') }}</a></p>
                    </div>
                  </form>
