...
<section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Formulaire d'ajout de correction de l'épreuve N°{{$epreuve->id}}</h5>

            <form class="row g-3" action="{{route('corrections.store',$epreuve->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
