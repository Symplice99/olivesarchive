<section class="section">
    <div class="row">
      <div class="col-lg-10">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Formulaire d'ajout d'exercice</h5>

            <form class="row g-3" action="{{route('exercices.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6">
                    ...
                    @error('nomMatiereExercice') is-invalid @enderror" value="{{old('nomMatiereExercice')?? ''}}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="numberpositif" name="prixExercice" class="form-control @error('prixExercice') is-invalid @enderror" value="{{old('prixExercice')?? ''}}" placeholder="Ex: 200">
                    @error('prixExercice')
                        <span class="text-danger"> {{$message}}</span>
                    @enderror
                </div>
                <div class="col-md-12">
                    ...
                    <input type="text" name="sourceExercice" class="form-control @error('sourceExercice') is-invalid @enderror"  value="{{old('sourceExercice')?? ''}}" placeholder="La source de l'exercice">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="filiereExercice" class="form-control @error('filiereExercice') is-invalid @enderror" value="{{old('filiereExercice')?? ''}}" placeholder="Classe">
                ...
                <div class="col-12">
                    ...
                    <textarea id="monTextarea" oninput="compterCaracteres()" class="form-control @error('descriptionExercice') is-invalid @enderror" name="descriptionExercice" value="" placeholder="Décrivez l'exercice" id="floatingTextarea" style="height: 100px;">{{old('descriptionExercice')?? ''}}</textarea>
