						...
						<div class="bg-body shadow text-start p-4">
							...
							<blockquote>
								<p class="me-3">
									...
									<span class="small">{{ $cour->description}}</span>
							...
							<a href="#"  class="btn btn-light justify-content-start align-items-center">
                                <div class="avatar avatar-xl">
                                    <span class="display-6 text-primary"><i class="bx bxs-download"></i></span>
                                </div>
                                <span class="text-secondary fw-bold  me-2">Télécharger ce cours
                                </span>
                            </a>
						</div>
					</div>
